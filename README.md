...
- to use Postman for basic SOAP requests and to automate testing API REST requests assertions with CI/CD Github actions (and got an API Test Automation badge from Postman)
